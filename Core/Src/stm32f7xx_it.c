...
void USART3_IRQHandler(void)
{
  /* USER CODE BEGIN USART3_IRQn 0 */
	INT32U	tmp_flag = 0, tmp_it_source = 0;
	INT08U	nTmp = 0;
	...
	{
		nTmp = (uint8_t)((uint16_t)READ_REG(huart3.Instance->RDR) & 0x00FF);
...
void UART4_IRQHandler(void)
{
  /* USER CODE BEGIN UART4_IRQn 0 */
	...
	if ((tmp_flag != RESET) && (tmp_it_source != RESET))
	{
		nTmp = (uint8_t)((uint16_t)READ_REG(huart4.Instance->RDR) & 0x00FF);
...
void USART6_IRQHandler(void)
{
  /* USER CODE BEGIN USART6_IRQn 0 */
	...
	tmp_flag = __HAL_UART_GET_FLAG(&huart6, UART_FLAG_RXNE);
	tmp_it_source = __HAL_UART_GET_IT_SOURCE(&huart6, UART_IT_RXNE);

	if ((tmp_flag != RESET) && (tmp_it_source != RESET))
	{
		nTmp = (uint8_t)((uint16_t)READ_REG(huart6.Instance->RDR) & 0x00FF);

		rsComHandler_485(nTmp);
	}
